...
describe 'User update a menu item option' do
  context 'update dish options' do
    it "and unauthenticated users shouldn't access to the edit form" do
      ...
      visit edit_restaurant_menu_item_option_path(restaurant, dish, option)
    ...
    it "and users who do not belong to this restaurant shouldn't access the edit form " do
      ...
      visit edit_restaurant_menu_item_option_path(first_restaurant, dish, option)

      expect(current_path).to eq root_path
    end

    it 'and when access the edit menu_item_option form from dish details page should see all fields filled' do
      user = User.create!(email: 'teste@gmail.com', password: 'password1234', cpf: '00085364061', name: 'teste', last_name: 'da silva')
      restaurant = Restaurant.create!(corporate_name: 'hot lanches xyz', brand_name: 'hot lanches', cnpj: '84685592000112',
                                      full_address:'Rua da Hot, 721 - RJ',email:'contato@hotlanches.com', phone_number: '81987654321', user: user)
      dish = Dish.create!(name: 'Bife a cavalo', description: 'Prato da casa', calories: 10, is_active: false, restaurant: restaurant)
      ...
      expect(current_path).to eq edit_restaurant_menu_item_option_path(restaurant, dish, option)
  ...
  context 'update beverage options' do 
    it "and unauthenticated users shouldn't access to the edit form" do
      ...
      option = MenuItemOption.create!(description: 'Jarra', price: 30, menu_item: beverage)

      visit edit_restaurant_menu_item_option_path(restaurant, beverage, option)
    ...
    it "and users who do not belong to this restaurant shouldn't access the edit form " do
      ...
      login_as(second_user)
      visit edit_restaurant_menu_item_option_path(first_restaurant, beverage, option)

      expect(current_path).to eq root_path
    end

    it 'and when access the edit menu_item_option form from beverage details page should see all fields filled' do
      user = User.create!(email: 'teste@gmail.com', password: 'password1234', cpf: '00085364061', name: 'teste', last_name: 'da silva')
      restaurant = Restaurant.create!(corporate_name: 'hot lanches xyz', brand_name: 'hot lanches', cnpj: '84685592000112',
                                      full_address:'Rua da Hot, 721 - RJ',email:'contato@hotlanches.com', phone_number: '81987654321', user: user)
      beverage = Beverage.create!(name: 'Suco de laranja', description: 'Suco feito da polpa', calories: 100, alcoholic: false, restaurant: restaurant)
      ...
      expect(current_path).to eq edit_restaurant_menu_item_option_path(restaurant, beverage, option)
